              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="mt-3 text-sm leading-7 text-stone-700">
                    Placeholder team member profile. Replace with approved company information as needed.
                  </p>
                  <div className="mt-6 flex gap-3">
                    ...
                    <Link href="mailto:hello@yourcompany.com" className="inline-flex items-center justify-center border border-stone-300 px-4 py-3 text-stone-950 transition hover:border-amber-500 hover:text-amber-600">
